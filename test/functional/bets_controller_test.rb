...
class BetsControllerTest < ActionController::TestCase
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post :create, bet: { amount: @bet.amount, bet_home: @bet.bet_home, event_id: @bet.event_id, user_id: @bet.user_id }
    end
  ...
  test "should update bet" do
    put :update, id: @bet, bet: { amount: @bet.amount, bet_home: @bet.bet_home, event_id: @bet.event_id, user_id: @bet.user_id }
    assert_redirected_to bet_path(assigns(:bet))
  end
